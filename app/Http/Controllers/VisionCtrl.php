...
class VisionCtrl extends Controller
{
    //

    //Vision and Mission
      public function visionFunc()
      {
        ...
        $var1 = DB::table('vision_middle')
                ->get();

        $var2 = DB::table('vision_footer')
                ->get();
        ...
        return view('home.vision',$data);
         ...
         //Vision and Mission
      public function cmvisionFunc()
      {
        
        return view('home.cm_vision');
      }
      
      
           //Vision and Mission
      public function stvisionFunc()
      {
        
        return view('home.st_vision');
      }
      
      
           //Vision and Mission
      public function mlsvisionFunc()
      {
        
        return view('home.mls_vision');
      }
