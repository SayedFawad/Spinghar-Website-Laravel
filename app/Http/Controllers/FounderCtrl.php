...
class FounderCtrl extends Controller
{
    //

    //Founder Message
      public function founderMsgFunc()
      {
        //about page controller
        $Var = DB::table('founder')
                ->where('ID',1)
                ->get();

        $var1 = DB::table('founder_middle')
                ->get();

        $var2 = DB::table('founder_footer')
                ->get();
    ...
    public function admin()
      ...
      if(session()->has('session_login'))
      {
        ...
        $data = array(
          ...
          'footer'=>$var2
                ...
                return view('home.admin_founder',$data);
      }
      else
      {
       ...
       if(session()->has('session_login'))
        ...
        $data1 = array(
          ...
          'footer'=>$var2
                ...
                return view('home.admin_founder',$data1);
     ...
     public function uploadFounderMainImg(Request $store)
     {
             if(session()->has('session_login'))
              {
...
public function updateFounderMainTitle(Request $req)
        {
          if(session()->has('session_login'))
          {
  ...
  public function updateFounderMainInfo(Request $req)
        {
          if(session()->has('session_login'))
          {
