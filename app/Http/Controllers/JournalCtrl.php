...
class JournalCtrl extends Controller
{
    //

    //Research Journal
      public function journalFunc()
      {
        
        $Var = DB::table('journal')
                ->where('ID',1)
                ->get();

        $var1 = DB::table('journal_middle')
                ->get();

        $var2 = DB::table('journal_footer')
                ->get();
